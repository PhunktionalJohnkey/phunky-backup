resource "aws_s3_bucket" "phunkytechlogs" {
...
data "aws_iam_policy_document" "alb_logs_s3" {
  ...
  statement {
    ...
    resources = ["${aws_s3_bucket.phunkytechlogs[0].arn}/${var.logs_prefix}/AWSLogs/${var.account_id}/*"]
  ...
  statement {
    ...
    resources = [aws_s3_bucket.phunkytechlogs[0].arn]
...
resource "aws_s3_bucket_policy" "alb_logs" {
  ...
  bucket = aws_s3_bucket.phunkytechlogs[0].id
